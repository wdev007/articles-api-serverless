...
describe('DeleteService', () => {
  it('should be able delete article', async () => {
    ...
    const deleteService = new DeleteService(httpResponse, repository);
    ...
    const response: any = await deleteService.handler(event, {} as any, () => {});
